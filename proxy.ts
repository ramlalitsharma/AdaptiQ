...
function addSecurityHeaders(response: NextResponse) {
    const csp = [
        "default-src 'self'",
        "script-src 'self' 'unsafe-eval' 'unsafe-inline' https://*.clerk.com https://*.clerk.accounts.dev https://cdn.jsdelivr.net https://*.meet.jit.si https://pagead2.googlesyndication.com https://adservice.google.com https://va.vercel-scripts.com https://www.googletagmanager.com https://app.posthog.com",
        ...
        "connect-src 'self' https://*.clerk.com https://*.clerk.accounts.dev https://clerk-telemetry.com https://api.openai.com https://*.openai.com wss://*.clerk.com https://*.meet.jit.si wss://*.meet.jit.si https://*.jitsi.net https://va.vercel-scripts.com https://vitals.vercel-analytics.com https://www.google-analytics.com https://app.posthog.com",
