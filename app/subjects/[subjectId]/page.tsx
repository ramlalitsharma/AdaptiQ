...
export default async function SubjectDetailPage({ params }: SubjectPageProps) {
  ...
  if (!slugParam) {
    return (
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <Link href="/subjects" className="text-blue-600 hover:underline">← Back to Subjects</Link>
      </div>
    );
  }
  ...
  if (!subject) {
    ...
    const newDoc = { name: nameFromSlug, slug, description: `${nameFromSlug} autogenerated subject`, icon: '📚', color: 'blue', category: 'academic', levels, isActive: true, createdAt: new Date(), updatedAt: new Date() };
    try {
